...
namespace linuxserialport
{
    ...
    ///     the standard baud rates as provided by UNIX, CUSTOM
    ///     represents a baud rate defined by an arbitray integer.
    ...
    ///     SerialPort class
    /// \details Specifies all the same baud rates as UNIX, as well as
    ///     B_CUSTOM to specify your
    ...
    public:
        ...
        /// \details Only call when state != OPEN. This method manupulates
        ///     VMIN and VTIME.
        /// \param timeout_ms  Set to -1 to infinite timeout, 0 to return
        ///     immediately with any data (non
        ///     blocking, or >0 to wait for data for a specified number of
        ///     milliseconds). Timeout will
        ///     be rounded to the nearest 100ms (a Linux API restriction).
        ///     Maximum value limited to
        ...
        /// \param data	The object the read characters from the COM port will
        ///     be saved to.
        /// \param wait_ms The amount of time to wait for data. Set to 0 for
        ///      non-blocking mode. Set to -1 to wait indefinitely for new
        ///      data.
        /// \throws CppLinuxSerial::Exception if state != OPEN.
        void read(std::string& data);
        ///
        /// \brief Use to enable/disable serial port stream output.
        /// \param mustBeEnabled: Boolean flag that determines enable or
        ///     disable state.
        ///     true: Enable stream output.
        ///     false: Disable stream output.
        ///
        void enableDisableStreamOutput(bool mustBeEnabled);
        ///
        /// \brief Use to enable removing crlf from outpu.
        ///
        //void removeCrlfFromOutput();
        ///
        /// \brief Use to disable removing crlf from outpu.
        ///
        //void addCrlfToOutput();
    ...
    private:
        ...
        /// \brief Assigns the provided tty settings to the serial port
        ///     pointed to by the file descriptor.
        void setTermios2(termios2 tty);
        ///
        /// \brief Is used to activate/deactivate removing crlf from inpu
        ///
        //bool isRemoveCrLfActive = false;
        ///
        /// \brief Is used to active/deactive flow control of serial port.
        ///
        bool isEnableHWFlowControl = false;
        ///
        /// \brief first time that app try to change serial port setting
        /// it is needed to get backup of original setting.Next variable
        /// will be used to get this backup first time.
        ///
        bool isNeedToHoldOriginalSetting = true;

        /// \brief Keeps track of the serial port's state.
        State mState;

        /// \brief The file path to the serial port device
        ///     (e.g. "/dev/ttyUSB0").
        std::string mDevice;
        ...
        int mFileDesc;
        ///
        /// \brief To restore the serial port settings to their original
        ///     state next variable will be used.
        ///
        termios2 mOriginalSetting;
        ...
        unsigned char mReadBufferSizeB;

        static constexpr BaudRate kDefaultBaudRate = BaudRate::B_57600;
        static constexpr int32_t kDefaultTimeoutMs = -1;
        static constexpr unsigned char kDefaultReadBufferSizeB = 255;
    };
